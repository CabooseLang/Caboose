...
static bool callValue(Value callee, int argCount) {
  if (IS_OBJ(callee)) switch (OBJ_TYPE(callee)) {
	case OBJ_FUNCTION:
...
/**
 * Push a value into the virtual machine.
...
/**
 * Retrieve the value from the top of the virtual machine.
 * @return The value at the top of the VM.
 */
Value pop() {
  vm.stackTop--;
  return *vm.stackTop;
