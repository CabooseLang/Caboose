        ...
        case OBJ_LIST: {
            ...
            for (int i = 0; i < list->values.count; ++i) {
                ...
                if (elementSize > (size - listStringSize - 1)) {
                    if (elementSize > size * 2) size += elementSize * 2;
                    else size *= 2;
                ...
                if (i != list->values.count - 1) strncat(listString, ", ", size - listStringSize - 1);
            }
        ...
        case OBJ_DICT: {
            ...
            for (int i = 0; i < dict->capacity; ++i) {
                ...
                if (keySize > (size - dictStringSize - 1)) {
                    if (keySize > size * 2) size += keySize * 2;
                    else size *= 2;
                ...
                if (count != dict->count) strncat(dictString, ", ", size - dictStringSize - 1);
            }
