...
Token scanToken() {
    ...
    switch (c) {
        ...
        case '-': {
            if (match('-')) return makeToken(TOKEN_DECREMENT);
            else if (match('=')) return makeToken(TOKEN_MINUS_EQUALS);
            else return makeToken(TOKEN_MINUS);
        }
        case '+': {
            if (match('+')) return makeToken(TOKEN_INCREMENT);
            else if (match('=')) return makeToken(TOKEN_PLUS_EQUALS);
